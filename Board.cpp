...
Board::Board() : filled(nullptr), size(3), lastplayer(true), i1(0)
{
...
Board::Board(const Board& other) : filled(nullptr), size(other.size), boardsize(other.boardsize), lastplayer(other.lastplayer), i1(other.i1)
{
